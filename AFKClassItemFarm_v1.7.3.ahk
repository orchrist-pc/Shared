...
/*
	...
	settingsgui:
		...
		gui add, button, x5 y340 w280 h25 +default, save
		; draw save button first to ensure it is default 

		gui font, s12 bold q5 cblack, verdana
		gui add, groupbox, x5 y5 w280 h150, Fast Travel Settings
		gui font, s11 norm q5 cblack, verdana

		gui add, text, x15 y30 w150 h25 +0x200, Fast Travel Selection:
		gui add, edit, x195 y30 w75 h25 vfasttravel_sleep, %fasttravel_sleep%

		gui add, text, x15 y60 w150 h25 +0x200, Fast Travel Delay:
		gui add, edit, x195 y60 w75 h25 vfasttravel_wait, %fasttravel_wait%

		gui add, text, x15 y90 w150 h25 +0x200, Orbit Cursor Right:
		gui add, edit, x195 y90 w75 h25 vorbit_launcher_right, %orbit_launcher_right%

		gui add, text, x15 y120 w150 h25 +0x200, Orbit Cursor Down:
		gui add, edit, x195 y120 w75 h25 vorbit_launcher_down, %orbit_launcher_down%

		gui font, s12 bold q5 cblack, verdana
		gui add, groupbox, x5 y155 w280 h180, Chest Farm Settings
		gui font, s11 norm q5 cblack, verdana

		gui add, text, x15 y180 w150 h25 +0x200, Initial Aim:
		gui add, edit, x195 y180 w75 h25 vinitial_aim, %initial_aim%

		gui add, text, x15 y210 w150 h25 +0x200, Pre-Turn Duration:
		gui add, edit, x195 y210 w75 h25 vpre_arc_sleep, %pre_arc_sleep%

		gui add, text, x15 y240 w150 h25 +0x200, Turn Duration:
		gui add, edit, x195 y240 w75 h25 varc_sleep, %arc_sleep%

		gui add, text, x15 y270 w150 h25 +0x200, Post-Turn Duration:
		gui add, edit, x195 y270 w75 h25 vpost_arc_sleep, %post_arc_sleep%

		gui add, text, x15 y300 w150 h25 +0x200, Chest Spawn Delay:
		gui add, edit, x195 y300 w75 h25 vwait_for_chest_spawn, %wait_for_chest_spawn%
